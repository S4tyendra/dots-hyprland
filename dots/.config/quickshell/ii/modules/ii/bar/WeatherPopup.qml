    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            WeatherCard {
                ...
                cardColor: Qt.rgba(0.15, 0.25, 0.35, 0.9)
                accentColor: Qt.rgba(0.4, 0.7, 1.0, 1)
            }
            WeatherCard {
                title: Translation.tr("Wind")
                symbol: "air"
                value: `${Weather.data?.wind ?? "1.2 km/h"}`
                cardColor: Qt.rgba(0.2, 0.3, 0.2, 0.9)
                accentColor: Qt.rgba(0.5, 0.9, 0.5, 1)
            }
            WeatherCard {
                title: Translation.tr("Precipitation")
                symbol: "rainy_light"
                value: Weather.data?.precip ?? "10%"
                cardColor: Qt.rgba(0.15, 0.2, 0.3, 0.9)
                accentColor: Qt.rgba(0.5, 0.6, 1.0, 1)
            }
            WeatherCard {
                title: Translation.tr("Humidity")
                symbol: "humidity_low"
                value: Weather.data?.humidity ?? "65%"
                cardColor: Qt.rgba(0.2, 0.15, 0.3, 0.9)
                accentColor: Qt.rgba(0.7, 0.5, 1.0, 1)
            }
            WeatherCard {
                title: Translation.tr("Visibility")
                symbol: "visibility"
                value: Weather.data?.visib ?? "10 km"
                cardColor: Qt.rgba(0.25, 0.25, 0.15, 0.9)
                accentColor: Qt.rgba(1.0, 0.9, 0.4, 1)
            }
            WeatherCard {
                title: Translation.tr("Pressure")
                symbol: "readiness_score"
                value: Weather.data?.press ?? "720 hpa"
                cardColor: Qt.rgba(0.3, 0.15, 0.15, 0.9)
                accentColor: Qt.rgba(1.0, 0.5, 0.4, 1)
            }
        }
    }
}
