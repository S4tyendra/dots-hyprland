    ...
    Flow {
        ...
        Component {
            ...
            Item {
                ...
                property bool isRecording: Config.options.bar.utilButtons.isRecording || wfRecorderRunning
                ...
                Process {
                    ...
                    onExited: (exitCode, exitStatus) => {
                        recordingItem.wfRecorderRunning = (exitCode === 0)
                    }
                }
        ...
        Component {
            ...
            UtilButton {
                property bool wfRecorderRunning: false
                iconText: (Config.options.bar.utilButtons.isRecording || wfRecorderRunning) ? "stop_circle" : "screen_record"
                forceHovered: Config.options.bar.utilButtons.isRecording || wfRecorderRunning
                onClicked: Quickshell.execDetached([Directories.recordScriptPath])
                Timer {
                    interval: 3000
                    repeat: true
                ...
                Process {
                    ...
                    command: ["pidof", "wf-recorder"]
                    onExited: (exitCode, exitStatus) => {
                        parent.wfRecorderRunning = (exitCode === 0)
                    }
                }
            }
        }
