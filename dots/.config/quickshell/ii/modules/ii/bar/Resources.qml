...
BarWidgetSwitcherArea {
    ...
    rowDefault: Component {
        RowLayout {
            ...
            Resource {
                iconName: "thermostat"
                shown: Config.options.bar.resources.alwaysShowCpuTemp && !isNaN(ResourceUsage.cpuTemp) && ResourceUsage.cpuTemp > 0
    ...
    colDefault: Component {
        ColumnLayout {
            ...
            Resource {
                ...
                iconName: "thermostat"
                vertical: true
                visible: Config.options.bar.resources.alwaysShowCpuTemp && !isNaN(ResourceUsage.cpuTemp) && ResourceUsage.cpuTemp > 0
                percentage: ResourceUsage.cpuTemp / 100
            }
            Resource {
                Layout.alignment: Qt.AlignHCenter
