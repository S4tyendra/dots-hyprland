        ...
        LazyLoader {
            ...
            component: PanelWindow { // Bar window
                ...
                MouseArea  {
                    ...
                    Item {
                        id: hoverMaskRegion
                        // Anchored to screen edge (PanelWindow), not barContent.
                        // When bar is hidden, mask shrinks to hover strip at screen edge.
                        // When bar is shown, mask grows to cover bar + hover region.
                        property bool autoHidden: Config?.options.bar.autoHide.enable && !mustShow
                        property real hoverW: Config.options.bar.autoHide.hoverRegionWidth
                        x: 0
                        width: parent.width

                        // Top bar: grow downward from y=0
                        // Bottom bar: grow upward from bottom edge
                        y: Config.options.bar.bottom
                            ? parent.height - height
                            : 0
                        height: autoHidden
                            ? hoverW * 2
                            : Appearance.sizes.barHeight + hoverW * 2
                    }
