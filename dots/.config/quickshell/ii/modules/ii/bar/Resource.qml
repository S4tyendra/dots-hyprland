...
Item {
    ...
    readonly property real safePercentage: isNaN(percentage) ? 0 : percentage
    property bool warning: safePercentage * 100 >= warningThreshold

    Component {
        id: outlineStyle
        ClippedOutlineCircularProgress {
            lineWidth: Appearance.rounding.unsharpen
            value: root.safePercentage
    ...
    RowLayout {
        ...
        Item {
            ...
            StyledText {
                ...
                font.pixelSize: Appearance.font.pixelSize.small
                text: isNaN(root.percentage) ? "N/A" : `${Math.round(root.safePercentage * 100).toString()}`
            }
        }
