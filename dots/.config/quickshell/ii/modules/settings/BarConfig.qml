...
ContentPage {
    ...
    property var allWidgets: [
        ...
        { id: "netSpeedIndicator", name: Translation.tr("Network (Today)"),      icon: "network_check" },
    ...
    ColumnLayout {
        ...
        ContentSection {
            ...
            GroupedList {
                ...
                ConfigSwitch {
                    buttonIcon: "graphic_eq"; text: Translation.tr("Show waveform visualizer")
        ...
        ContentSection {
            ...
            GroupedList {
                ConfigSwitch {
                    buttonIcon: "calendar_today"; text: Translation.tr("Show date")
                    checked: Config.options.bar.verbose
                    onCheckedChanged: { Config.options.bar.verbose = checked; }
                }
                ConfigSwitch {
                    buttonIcon: "pace"; text: Translation.tr("Show seconds in time")
        ...
        ContentSection {
            ...
            GroupedList {
                ConfigSwitch {
                    buttonIcon: "battery_std"; text: Translation.tr("Show battery in system indicators")
                    checked: Config.options.bar.indicators.showBattery
                    onCheckedChanged: { Config.options.bar.indicators.showBattery = checked; }
                }
            }
        }
